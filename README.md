...
2. Click on the  <a href="tma.apk" tagret="_blank" download="tma.apk">APK file</a> in the tmapostapp directory and select the download button. Download it to your Download directory from step one above.
